...
export interface Pair {
  ...
  readonly untrackedVolumeFTM: Scalars['BigDecimal'];
  readonly untrackedVolumeUSD: Scalars['BigDecimal'];
  readonly volumeFTM: Scalars['BigDecimal'];
...
export interface Pair_Filter {
  ...
  readonly reserveFTM_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
  ...
  readonly reserveFTM_not_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
  ...
  readonly trackedReserveFTM_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
  ...
  readonly trackedReserveFTM_not_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
  ...
  readonly untrackedVolumeFTM?: Maybe<Scalars['BigDecimal']>;
  readonly untrackedVolumeFTM_gt?: Maybe<Scalars['BigDecimal']>;
  readonly untrackedVolumeFTM_gte?: Maybe<Scalars['BigDecimal']>;
  readonly untrackedVolumeFTM_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
  readonly untrackedVolumeFTM_lt?: Maybe<Scalars['BigDecimal']>;
  readonly untrackedVolumeFTM_lte?: Maybe<Scalars['BigDecimal']>;
  readonly untrackedVolumeFTM_not?: Maybe<Scalars['BigDecimal']>;
  readonly untrackedVolumeFTM_not_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
  ...
  readonly volumeFTM?: Maybe<Scalars['BigDecimal']>;
  readonly volumeFTM_gt?: Maybe<Scalars['BigDecimal']>;
  readonly volumeFTM_gte?: Maybe<Scalars['BigDecimal']>;
  readonly volumeFTM_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
  readonly volumeFTM_lt?: Maybe<Scalars['BigDecimal']>;
  readonly volumeFTM_lte?: Maybe<Scalars['BigDecimal']>;
  readonly volumeFTM_not?: Maybe<Scalars['BigDecimal']>;
  readonly volumeFTM_not_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
...
export enum Pair_OrderBy {
  ...
  Reserve0 = 'reserve0',
  Reserve1 = 'reserve1',
  ReserveBnb = 'reserveFTM',
  ReserveUsd = 'reserveUSD',
  Token0 = 'token0',
  Token0Price = 'token0Price',
  Token1 = 'token1',
  Token1Price = 'token1Price',
  TrackedReserveBnb = 'trackedReserveFTM',
  TrackedReserveUsd = 'trackedReserveUSD',
  UntrackedVolumeBnb = 'untrackedVolumeFTM',
...
export interface Token {
  ...
  readonly derivedFTM: Scalars['BigDecimal'];
...
export interface Token_Filter {
  ...
  readonly derivedFTM_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
  ...
  readonly derivedFTM_not_in?: Maybe<ReadonlyArray<Scalars['BigDecimal']>>;
...
export type TokenQuery = (
  ...
  & { readonly token?: Maybe<(
    { readonly __typename?: 'Token' }
    & Pick<Token, 'id' | 'name' | 'symbol' | 'derivedFTM' | 'derivedUSD'>
  )> }
);
...
export type TopPairsQuery = (
  ...
  & { readonly pairs: ReadonlyArray<(
    { readonly __typename?: 'Pair' }
    & Pick<Pair, 'id' | 'reserve0' | 'reserve1' | 'volumeToken0' | 'volumeToken1' | 'reserveFTM' | 'reserveUSD'>
    & { readonly token0: (
      { readonly __typename?: 'Token' }
      & TokenInfoFragment
    ), readonly token1: (
